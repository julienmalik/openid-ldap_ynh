...
$GLOBALS['html'] = array (
	...
	'page_title'		=> 'Yunohost OpenID Provider',
	...
	'welcome_text'		=> 'Dear yunohost user, you have an OpenID unique identifier (<font color="#FB6000"><b>%s</b></font>, for example) which you can then use to log on to all Web sites that are OpenID-enabled (over 450 and counting, see the <a href="http://openiddirectory.com">Directory</a> for a partial listing of the sites). Please enter your yunohost login below to find out what is your identifier and access your OpenID custom status page.<br/><form method="post" action="showme.php">Username: <input type="text" id="login" class="loginurl" name="login"> <input type="submit" name="submit" value="Enter"></form>', // note "%s" which represents example OpenID
	'welcome_help'		=> 'You can find more information at <a href="http://openid.net/">http://openid.net/</a>.',
	'user_not_found'	=> 'User "%s" is not found, sorry.' // note "%s" is username here
);
